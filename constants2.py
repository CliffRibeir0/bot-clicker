class Config:
    ...
    SHOW_SELECTED_POS  = (475, 620)  

    #  posição do botão "Cancel All"
    CANCEL_ALL_POS     = (390, 620)  
    ...
    SCROLL_START_FIND  = (SCROLL_START[0], int(SCROLL_START[0]*2.35))  #(250, 575) 
    ...
    COL_REGION         = (159, 173, 40, 415)  

    #  região da unidade quando o parâmetro está isolado
    UNIT_REGION        = (1080,180,120,35)  

     # região do nome do parâmetro com a coluna Range
    NAME_REGION_WITH_RANGE_COLUMN  = (195, 175, 623, 45) 

    # região do nome do parâmetro sem a coluna Range
    NAME_REGION_WITHOUT_RANGE_COLUMN  = (195, 175, 740, 45)  

    # região do value do parâmetro com a coluna Range
    VALUE_REGION_WITH_RANGE_COLUMN = (820, 180, 110, 35)  

    # região do value do parâmetro sem a coluna Range
    VALUE_REGION_WITHOUT_RANGE_COLUMN = (945, 180, 110, 35)  
    ...
    #  ID de request
    CAN_REQUEST_IDS    = [0x7E0]  #[0x7E0, 0x7DF]  
